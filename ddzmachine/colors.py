...
UNIT_TYPES = [
    ...
    115, 116, 117, 118, 119, 125, 126, 127, 128, 129, 130, 132, 133, 134, 135,
    136, 137, 138, 139, 140, 141, 142, 146, 147, 149, 150, 151, 268, 289, 311,
    324, 330, 335, 341, 342, 343, 365, 371, 376, 377, 473, 474, 483, 484, 485,
    486, 487, 488, 489, 490, 493, 494, 495, 496, 498, 499, 500, 501, 502, 503,
    504, 559, 560, 561, 562, 588, 589, 590, 591, 608, 641, 665, 666, 687, 688,
    689, 691, 692, 693, 694, 732, 733, 734, 801, 824, 830, 892, 893, 894,
]
...
def unit_type(scale):
  ...
  assert len(UNIT_TYPES) <= len(distinct_colors)
  for i, v in enumerate(UNIT_TYPES):
